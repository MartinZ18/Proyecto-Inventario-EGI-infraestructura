...
//
//  NOTA IMPORTANTE: en mongosh los numeros se guardan como 'double' por
//  defecto. Por eso TODOS los campos que el esquema define como entero
//  usan NumberInt(...). Si los cargaras como numero pelado (ej: 8 en vez
...
db.createCollection('computadoras', {
  validator: {
    $jsonSchema: {
      ...
      properties: {
        id_equipo:         { bsonType: 'int', description: 'Clave puente -> MySQL Equipo.id_equipo' },
        ...
        pantalla_integrada: { // solo laptop
          bsonType: 'object',
          properties: {
            pulgadas:   { bsonType: ['double', 'int'] },
      ...
      // Regla condicional del diagrama:
      //   desktop  -> obliga 'perifericos'
      //   laptop   -> obliga 'bateria' y 'pantalla_integrada'
      // Se modela con oneOf: cada documento matchea exactamente una rama
      // segun su 'tipo'.
      oneOf: [
